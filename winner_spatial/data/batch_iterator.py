from re import A
from winner_spatial.data.dataloader import FixedLengthBatchSampler, SimpleDataset, COCODataset, FlickrDataset, VidstgDataset
from winner_spatial.blocks.negative_sampler import choose_negative_samples
...
class BatchIterator(object):
    ...
    def get_dataset(self):
        ...
        elif use_obj and data_type == 'vidstg':
            dataset = VidstgDataset(self.sentences, mode)
        else:
    ...
    def get_iterator(self, **kwargs):
        ...
        def collate_fn(batch):
            ...
            index, sents, obj_feats, boxes, obj_cates, gt_boxes, gt_proposal, \
                        pred_proposal, video_ids, target_tokens, pair_tokens, gt_tubes_index, \
                         = zip(*batch)
            ...
            batch_map['gt_boxes'] = gt_boxes
            batch_map['gt_proposal'] = gt_proposal
            batch_map['pred_proposal'] = pred_proposal
            batch_map['video_ids'] = video_ids
            batch_map['target_tokens'] = target_tokens
            batch_map['pair_tokens'] = pair_tokens
            batch_map['gt_tubes_index'] = gt_tubes_index
            # batch_map['noun_index_for_cal'] = noun_index_for_cal
        ...
        def myiterator():
            ...
            for batch in self.loader:
                ...
                batch_map['boxes'] = boxes
                batch_map['obj_cates'] = obj_cates
                batch_map['gt_boxes'] = batch['gt_boxes']
                batch_map['pred_proposal'] = batch['pred_proposal']
                batch_map['gt_proposal'] = batch['gt_proposal']
                batch_map['video_ids'] = batch['video_ids']
                batch_map['target_tokens'] = batch["target_tokens"]
                batch_map['pair_tokens'] = batch['pair_tokens']
                batch_map['gt_tubes_index'] = batch['gt_tubes_index']
                # batch_map['noun_index_for_cal'] = batch['noun_index_for_cal']
                yield batch_map

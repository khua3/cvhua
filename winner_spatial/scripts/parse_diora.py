...
def run(options):
    ...
    with torch.no_grad():
        for i, batch_map in tqdm(enumerate(batches)):
            ...
            super_loss += result['supervise_loss']
    ...
    print('recon_loss: {} ; vg_loss: {}; contr_loss: {}; super_loss: {}; total_loss: {}'.format(
        recon_loss/num_data, vg_loss/num_data, contr_loss/num_data, super_loss/num_data, total_loss/num_data))
